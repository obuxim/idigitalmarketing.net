        ...
        <div className="modal-content">
          ...
          <div className="modal-body">
            ...
            <div className="tab-content" id="myTabContent">
              ...
              >
                <form
                  className="form-row my-4 align-items-center"
                  onSubmit={submitLoginHandler}
                >
                  {error && (
                    <p style={{ color: "#e52d2d", textAlign: "left" }}>
                      <div dangerouslySetInnerHTML={createHTML(error)}></div>
                    </p>
                  )}
                ...
                <div className="login-social-media border pl-4 pr-4 pb-4 pt-0 rounded-sm">
                  <div className="mb-4 d-block text-center">
                    <b className="bg-white pl-2 pr-2 mt-3 d-block">
                  ...
                  <form className="row">
                    <div className="col-sm-6">
                      ...
                      >
                        <span>
                          <i className="fab fa-facebook-f mr-2"></i>Login with
                          Facebook
                        </span>
                      </a>
                    </div>
                    <div className="col-sm-6">
                      ...
                      >
                        <span>
                          <i className="fab fa-twitter mr-2"></i>Login with
                          Twitter
                        </span>
                      </a>
                    </div>
                    <div className="col-sm-6">
                      ...
                      >
                        <span>
                          <i className="fab fa-instagram mr-2"></i>Login with
                          Instagram
                        </span>
                      </a>
                    </div>
                    <div className="col-sm-6">
                      ...
                      >
                        <span>
                          <i className="fab fa-linkedin-in mr-2"></i>Login with
                          Linkedin
                        </span>
                      </a>
                    </div>
              ...
              >
                ...
                >
                  ...
                  {successMessage && (
                    <p style={{ color: "#5cb85c", textAlign: "left" }}>
                      {" "}
                      {`${successMessage} please login`} Login{" "}
                    </p>
                  )}
                  {message && (
                    <p style={{ color: "#e52d2d", textAlign: "left" }}>
